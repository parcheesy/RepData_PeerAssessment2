...
This analysis explores the human and economic effects of various weather patterns in the United States. Using the U.S. National Oceanic and Atmospheric Administration's (NOAA) storm database, the analysis involves determining the human harm, measured by fatalities and injuries, and economic damage, measured by property and crop damage, of different types of weather events.
